...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dilated=True, norm_layer=None, multi_grid=False, multi_dilation=None):
        self.inplanes = 64
...
def resnet50(pretrained=False, root='./pretrain_models', **kwargs):
    ...
    if pretrained:
        ...
        # model.load_state_dict(torch.load('./pretrained/resnet50-imagenet.pth'), strict=False)
    return model
...
def resnet152(pretrained=False, root='./pretrain_models', **kwargs):
